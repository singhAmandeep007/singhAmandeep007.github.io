export const data = {
  ...
  shortDescription: `Full stack engineer with 4+ years of professional experience, specializing in high-performance frontend applications. 
	\n Proficient in **TypeScript**, **React**, **Redux**, **Next.js**, **Node.js**, **SQL**, **Go** and more.
